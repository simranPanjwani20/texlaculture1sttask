...
EditorToolbar.propTypes = {
    ...
    handleFontStyleChange: PropTypes.func
};

export default function EditorToolbar({id, isSimple, quillRef, handleFontStyleChange, ...other}) {
    const fontOptions = {
        Nunito: 'Nunito', // Add Nunito font style option
    };
            ...
            <div id={id}>
                ...
                <div className="ql-formats">
                    <select className="ql-font" defaultValue=""
                            onChange={(event) => handleFontStyleChange(quillRef.current, event.target.value)}>
